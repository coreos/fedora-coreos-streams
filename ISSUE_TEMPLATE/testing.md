...
- For each [issue that is pending a testing release in the tracker](https://github.com/coreos/fedora-coreos-tracker/issues?q=is%3Aissue+label%3Astatus%2Fpending-testing-release):
